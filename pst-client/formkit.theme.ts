...
/**
  ...
  *
  * @checksum - e4676c3f9f3b2235a586c4db32aa44aed9f9f83454c7706768962fe2b68ddcc0
  * @variables - radius=rounded,accentColor=teal,colorTemperature=neutral,spacing=1.5,scale=sm,inputShadow=shadow-md,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-[20em],tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/
...
const classes: Record<string, Record<string, boolean>> = {
  ...
  "family:box__decorator": {
    ...
    "bg-white": true,
    "ring-teal-500": true,
    "peer-checked:border-teal-600": true,
    "relative": true,
    "block": true,
    "text-base": true,
    "w-[1em]": true,
    ...
    "peer-checked:bg-teal-50": true,
    "peer-checked:text-teal-600": true,
    ...
    "dark:ring-offset-teal-500": true,
    "dark:peer-focus-visible:ring-1": true,
    "dark:peer-disabled:bg-neutral-600/50": true,
    "dark:peer-checked:bg-teal-900": true,
    "dark:peer-checked:text-teal-400": true
  },
  ...
  "family:text__inner": {
    ...
    "focus-within:!ring-teal-500": true,
    "focus-within:!border-teal-500": true,
  ...
  "family:dropdown__listitem": {
    ...
    "text-neutral-700": true,
    "text-sm": true,
    "data-[is-active]:bg-teal-100": true,
    ...
    "data-[is-active]:before:ring-teal-500": true,
    "data-[is-active]:before:ring-inset": true,
    "data-[is-active]:before:ring-offset-teal-100": true
  },
  ...
  "family:dropdown__loadMoreInner": {
    ...
    "justify-center": true,
    "[&>span]:mr-1.5": true,
    "hover:text-teal-600": true,
    "cursor-pointer": true,
    "dark:text-neutral-200": true,
    "dark:hover:text-teal-500": true
  },
  ...
  "family:dropdown__tagWrapper": {
    ...
    "data-[active-selection=true]:ring-teal-500": true
  },
  ...
  "family:dropdown__tag": {
    ...
    "group-data-[active-selection=true]/tag:bg-teal-400": true,
  ...
  "family:dropdown__emptyMessage": {
    ...
    "aria-selected:bg-teal-600": true
  },
  "button__input": {
    "appearance-none": true,
    "[color-scheme:light]": true,
    ...
    "dark:text-teal-500": true,
    "dark:bg-transparent": true,
    "dark:hover:bg-teal-50/5": true
  },
  "checkbox__decorator": {
    "rounded": true
  },
  ...
  "date__input": {
    ...
    "selection:text-neutral-700": true,
    "group-data-[has-overlay]:selection:!text-transparent": true,
    "focus:[&::-webkit-datetime-edit-day-field]:bg-teal-100": true,
    "focus:[&::-webkit-datetime-edit-month-field]:bg-teal-100": true,
    "focus:[&::-webkit-datetime-edit-year-field]:bg-teal-100": true
  },
  "datetime-local__input": {
    ...
    "focus:[&::-webkit-datetime-edit-month-field]:bg-teal-100": true,
    "focus:[&::-webkit-datetime-edit-year-field]:bg-teal-100": true,
    "focus:[&::-webkit-datetime-edit-hour-field]:bg-teal-100": true,
    "focus:[&::-webkit-datetime-edit-minute-field]:bg-teal-100": true,
    "focus:[&::-webkit-datetime-edit-ampm-field]:bg-teal-100": true
  },
  "file__fileList": {
    "group/list": true,
    "peer": true,
  ...
  "file__fileRemove": {
    ...
    "peer-data-[has-multiple]:text-teal-600": true,
  ...
  "form__messageLink": {
    ...
    "group-[]/summary:ring-teal-600": true
  },
  "month__input": {
    "appearance-none": true,
    "[color-scheme:light]": true,
  ...
  "range__input": {
    ...
    "[&::-webkit-slider-thumb]:bg-teal-600": true,
    ...
    "[&::-webkit-slider-thumb]:focus:!ring-teal-500": true,
    ...
    "[&::-moz-range-thumb]:bg-teal-600": true,
    ...
    "[&::-moz-range-thumb]:focus:!ring-teal-500": true,
  ...
  "select__option": {
    ...
    "group-data-[multiple]:checked:bg-teal-100": true,
    "group-data-[multiple]:focus:bg-teal-100": true,
    ...
    "dark:bg-neutral-800": true,
    "dark:text-neutral-300": true,
    "dark:group-data-[multiple]:focus:bg-teal-800": true,
    "dark:group-data-[multiple]:checked:bg-teal-800": true
  },
  "select__prefixIcon": {
    "flex": true,
    "items-center": true,
  ...
  "submit__input": {
    ...
    "bg-teal-600": true,
    "!text-white": true,
    "active:text-teal-100": true,
    "active:bg-teal-700": true,
    "hover:bg-teal-700": true,
  ...
  "week__input": {
    ...
    "selection:text-neutral-700": true,
    "group-data-[has-overlay]:selection:!text-transparent": true,
    "focus:[&::-webkit-datetime-edit-week-field]:bg-teal-100": true,
    "focus:[&::-webkit-datetime-edit-year-field]:bg-teal-100": true
  },
  ...
  "colorpicker__control": {
    ...
    "focus-visible:ring-teal-500": true
  },
  ...
  "colorpicker__fieldGroup": {
    ...
    "[&>input]:selection:bg-teal-100": true,
    "[&>input]:m-0": true,
    "[&>input]:grow": true,
    "[&>input]:shrink": true,
    "[&>input]:w-full": true,
    ...
    "[&>input:focus]:ring-teal-600": true,
    "[&>input:focus]:border-teal-600": true,
  ...
  "colorpicker__swatch": {
    ...
    "[&>canvas:focus-visible]:ring-teal-500": true,
  ...
  "datepicker__dayCell": {
    ...
    "dark:bg-neutral-600": true,
    "dark:text-neutral-300": true,
    "dark:aria-selected:bg-teal-600": true,
    "dark:aria-selected:text-white": true,
    "dark:focus:outline-teal-600": true,
  ...
  "datepicker__timeInput": {
    ...
    "p-1.5": true,
    "my-2": true,
    "focus-visible:outline-teal-600": true,
    "dark:text-neutral-300": true,
    "dark:bg-transparent": true,
    "dark:border-neutral-600": true
  },
  ...
  "datepicker__dayButton": {
    ...
    "dark:text-neutral-300": true,
    "dark:border-neutral-600": true,
    "dark:hover:border-teal-500": true
  },
  ...
  "datepicker__calendarIcon": {
    "text-neutral-600": true,
    "focus-visible:text-teal-600": true,
    "flex": true,
    "w-[1em]": true,
    "grow-0": true,
    "shrink-0": true,
  ...
  "toggle__track": {
    ...
    "shadow": true,
    "peer-focus-visible:ring-2": true,
    "peer-focus-visible:ring-teal-500": true,
  ...
  "togglebuttons__input": {
    ...
    "dark:disabled:text-teal-500": true,
    "dark:text-teal-500": true,
    "aria-[pressed=true]:bg-teal-600": true,
    "aria-[pressed=true]:text-white": true,
    "dark:aria-[pressed=true]:bg-teal-600": true,
    ...
    "group-data-[vertical=false]/options:group-[]/option:aria-[pressed=true]:border-x-teal-500": true,
    "group-data-[vertical=false]/options:group-first/option:aria-[pressed=true]:border-l-teal-600": true,
    "group-data-[vertical=false]/options:group-last/option:aria-[pressed=true]:border-r-teal-600": true,
    "dark:group-data-[vertical=false]/options:group-[]/option:aria-[pressed=true]:border-x-teal-600": true,
    "dark:group-data-[vertical=false]/options:group-first/option:aria-[pressed=true]:border-l-teal-600": true,
    "dark:group-data-[vertical=false]/options:group-last/option:aria-[pressed=true]:border-r-teal-600": true,
    ...
    "group-data-[vertical=true]/options:group-[]/option:aria-[pressed=true]:border-y-teal-500": true,
    "group-data-[vertical=true]/options:group-first/option:aria-[pressed=true]:border-t-teal-600": true,
    "group-data-[vertical=true]/options:group-last/option:aria-[pressed=true]:border-b-teal-600": true,
    "dark:group-data-[vertical=true]/options:group-[]/option:aria-[pressed=true]:border-y-teal-600": true,
    "dark:group-data-[vertical=true]/options:group-first/option:aria-[pressed=true]:border-t-teal-600": true,
    "dark:group-data-[vertical=true]/options:group-last/option:aria-[pressed=true]:border-b-teal-600": true
  },
  "transferlist__outer": {
    "group": true,
    "min-w-0": true,
    ...
    "text-sm": true,
    "max-w-none": true,
    "[&_.dnd-placeholder]:bg-teal-600": true,
  ...
  "transferlist__transferlist": {
    ...
    "[&:has(:focus-visible)]:ring-teal-500": true,
    "dark:border-neutral-600": true,
  ...
  "transferlist__transferlistListItem": {
    ...
    "aria-selected:bg-teal-100": true,
    "data-[is-active=true]:bg-teal-100": true,
    "data-[is-active=true]:ring-teal-200": true,
    "aria-selected:ring-teal-200": true,
    "relative": true,
    "flex": true,
    "cursor-pointer": true,
    "items-center": true,
    ...
    "dark:bg-neutral-800": true,
    "dark:text-neutral-300": true,
    "dark:data-[is-active=true]:bg-teal-900": true,
    "dark:aria-selected:bg-teal-900": true,
    "dark:ring-neutral-700": true,
    "dark:data-[is-active=true]:ring-teal-600": true,
    "dark:aria-selected:ring-teal-600": true,
    "[&.formkit-dropZone]:bg-teal-100": true,
    "[&.formkit-selectionDropZone]:bg-teal-100": true,
    "[&.formkit-touchDropZone]:bg-teal-100": true,
    "[&.formkit-touchSelectionDropZone]:bg-teal-100": true,
    "[&.formkit-longTouch]:bg-teal-100": true,
    "dark:[&.formkit-dropZone]:bg-teal-900": true,
    "dark:[&.formkit-selectionDropZone]:bg-teal-900": true,
    "dark:[&.formkit-touchDropZone]:bg-teal-900": true,
    "dark:[&.formkit-touchSelectionDropZone]:bg-teal-900": true,
    "dark:[&.formkit-longTouch]:bg-teal-900": true
  },
  ...
  "transferlist__transferlistSearch": {
    ...
    "dark:border-neutral-600": true,
    "dark:text-neutral-300": true,
    "dark:selection:bg-teal-100": true,
    "dark:selection:text-neutral-700": true,
    "dark:bg-neutral-800": true
  },
  ...
  "multi-step__tab": {
    ...
    "group-data-[tab-style=progress]/wrapper:data-[valid=true]:data-[visited=true]:after:bg-teal-600": true,
    ...
    "dark:group-data-[tab-style=progress]/wrapper:data-[valid=true]:data-[visited=true]:after:bg-teal-600": true
  },
  ...
  "multi-step__badge": {
    ...
    "text-white": true,
    "rounded-full": true,
    "group-data-[valid=true]/tab:bg-teal-600": true,
